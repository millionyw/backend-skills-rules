...
| 规则 | 文件 | 解决的问题 |
|------|------|-----------|
| AGENTS_OPS_RULES | [AGENTS_OPS_RULES.md](rules/AGENTS_OPS_RULES.md) | **运维操作不规范导致服务器问题** — 七条强制规范：目录结构、防止幽灵进程（D 状态）、文件命名、启动检查清单、违规处理、脚本执行日志、运维文档反哺 |
...
| 运维强制规范 | 项目 `运维/AGENTS_OPS_RULES.md` | 服务器运维七条强制规范 |
